<?php
session_start();
if(!isset($_SESSION['welcomeID'])){ header('location:login.php'); }
                ...
                <?php 
                            ...
                            if($result-> num_rows > 0){
                                while($row = $result-> fetch_assoc()){
                                    ...
                                    ."</td><td>".$row["phone_number"]."</td><td>". $row["program"]."</td><td>"."<button type='button' class='btn btn-secondary' data-toggle='modal' data-target='#msgModal'>SMS</button> <button type='button' class='btn btn-secondary'>History</button>" ."</td></tr>";
                                }
                                echo"</table>";
                            }
                            else{
